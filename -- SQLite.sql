-- SQLite
INSERT INTO Hotel (idHotel, ville, pays, codePostal) VALUES
(1, 'Paris', 'France', 75001),
(2, 'Lyon', 'France', 69000);


INSERT INTO Client (idClient, adresse, ville, codePostal, email, numTelephone, nomComplet) VALUES
...
INSERT INTO Prestation (idPrestation, prix, description) VALUES
(1, 15, 'Petit-déjeuner'), 
...
INSERT INTO TypeChambre (idType, nomType, tarif) VALUES
(1, 'Simple', 80) ,
(2, 'Double', 120) ;

INSERT INTO Chambre (idChambre, numero, etage, fumeurs, idHotel, idType) VALUES
(1, 201, 2, 0, 1, 1) ,
(2, 502, 5, 1, 1, 2) ,
(3, 305, 3, 0, 2, 1) ,
(4, 410, 4, 0, 2, 2) ,
...
INSERT INTO Reservation (idReservation, dateDepare,  dateDarrive, idClient) VALUES
...
INSERT INTO Evaluation (idEvaluation, dateEvaluation, note, texteDescriptif, idClient, idHotel) VALUES
